...
void main() {
  BBCodeParser bbCodeParser = BBCodeParser([
    ...
    BBCodeTableColumnTag(),
      ...
      emojiParser: BBCodeEmojiParser(
          [BBCodeEmoji(':)', html: '<img src="grin.gif">')], ['b']));
  ...
  test('bold tags with argument', () {
    final BBCodeDocument result =
        bbCodeParser.parse('text [b=123]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with two arguments', () {
    final BBCodeDocument result =
        bbCodeParser.parse('text [b=123,456]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with quoted argument', () {
    final BBCodeDocument result =
        bbCodeParser.parse('text [b="[csf]"]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with two quoted argument', () {
    final BBCodeDocument result =
        bbCodeParser.parse('text [b="[ff]","[vv]"]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with number and quoted argument', () {
    final BBCodeDocument result =
        bbCodeParser.parse('text [b=123,"[vv]"]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with quoted and numbered argument', () {
    final BBCodeDocument result =
        bbCodeParser.parse('text [b="[vv]",123]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with two quoted and one numbered argument', () {
    final BBCodeDocument result =
        bbCodeParser.parse('text [b="[vv]",123,"[ff]"]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with one quoted and two numbered argument', () {
    final BBCodeDocument result =
        bbCodeParser.parse('text [b=456,"[vv]",123]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with argument in closing', () {
    final BBCodeDocument result =
        bbCodeParser.parse('text [b]bold text[/b=456] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with named argument without value', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with named argument', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a=123]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with two named arguments', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a=123,b=456]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with two named arguments without values', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a,b]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with quoted named argument', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a="[csf]"]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with two quoted named argument', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a="[ff]",b="[vv]"]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with number and quoted named argument', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a=123,b="[vv]"]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with quoted and numbered named argument', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a="[vv]",b=123]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with two quoted and one numbered named argument', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a="[vv]",b=123,c="[ff]"]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with one quoted and two numbered named argument', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a=456,b="[vv]",c=123]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with one quoted and two numbered named argument partially without values', () {
    final BBCodeDocument result =
    bbCodeParser.parse('text [b a,b="[vv]",c]bold text[/b] text');
    expect(result.toHtml(), 'text <strong>bold text</strong> text');
  });

  test('bold tags with named argument in closing', () {
    final BBCodeDocument result =
  ...
  test('two neighboring bold tags', () {
    final BBCodeDocument result =
  ...
  test('ordered numeric list', () {
    final BBCodeDocument result =
        bbCodeParser.parse('[list=1][*]item 1[*]item 2[/list]');
    expect(result.toHtml(), '<ol><li>item 1</li><li>item 2</li></ol>');
  });

  test('ordered alphabetic list', () {
    final BBCodeDocument result =
        bbCodeParser.parse('[list=a][*]item 1[*]item 2[/list]');
    expect(result.toHtml(), '<ol type="a"><li>item 1</li><li>item 2</li></ol>');
  });

  test('unordered list with bold item', () {
    final BBCodeDocument result =
  ...
  test('unordered list with closing tags not again opened', () {
    final BBCodeDocument result =
        bbCodeParser.parse('[list][*]item 1[/*]item 2[/list]');
    expect(result.toHtml(), '<ul><li>item 1</li><li>item 2</li></ul>');
  });

  test('unordered list with closing tags not again opened and three items', () {
    final BBCodeDocument result =
  ...
  test('unordered list with new lines', () {
    final BBCodeDocument result = bbCodeParser.parse('''[list]
[*]item 1
[*]item 2
[/list]''');
  ...
  test('table with border=0', () {
    final BBCodeDocument result =
    bbCodeParser.parse('[table border=0] a [||] b [--] c [||] d [/table]');
    expect(result.toHtml(),
