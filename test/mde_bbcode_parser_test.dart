...
void main() {
  ...
  test('bold tag inside quote with bold text', () {
    final BBCodeDocument result =
  ...
  test('left text and img inside url', () {
    final BBCodeDocument result =
  ...
  test('right text and img inside url', () {
    final BBCodeDocument result =
  ...
  test('bold text and img inside url', () {
  ...
  test('bold left text and img inside url', () {
    final BBCodeDocument result = mdebbCodeParser
  ...
  test('bold right text and img inside url', () {
    final BBCodeDocument result = mdebbCodeParser
  ...
  test('formatted text around img inside url', () {
